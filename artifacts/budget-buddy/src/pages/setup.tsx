...
const PETS = [
  {
    ...
    name: "Luna",
    species: "Cat",
    personality: "keeps your coins safe with quiet dignity 🌙",
  },
  {
    id: "mochi",
    emoji: "🐼",
    name: "Mochi",
    species: "Panda",
    personality: "turns every saved rupee into a happy little dance 🎋",
  },
  {
    id: "kitsune",
    emoji: "🦊",
    name: "Kitsune",
    species: "Fox",
    personality: "cunning with cash and always finds the better deal ✨",
  },
  {
    id: "ribbit",
    emoji: "🐸",
    name: "Ribbit",
    species: "Frog",
    personality: "hops into action the moment you overspend 🍃",
  },
];
...
export default function Setup() {
  ...
  async function handleFinish() {
    if (!user) {
      setError("not logged in — go back and sign in.");
      return;
    }
    setSaving(true);
    setError("");
        ...
        <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
          <div className="text-center space-y-2">
            ...
            <p className="text-foreground font-medium">
              how much are we working with this month?
            </p>
            <p className="font-accent text-base text-muted-foreground">
              stipend, salary, pocket money — whatever comes in
            </p>
          </div>
      ...
      {step === 2 && (
        <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
          <div className="text-center space-y-2">
            ...
            <p className="font-accent text-base text-muted-foreground">
              imagine already having it. now let's make it real 💎
            </p>
          </div>
      ...
      {step === 3 && (
        <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
          <div className="text-center space-y-2">
            ...
            <p className="text-foreground font-medium">
              pick a little buddy to keep you accountable 🐾
            </p>
            <p className="font-accent text-base text-muted-foreground">
              they'll cheer you on when you save and side-eye you when you don't
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            {PETS.map((p) => (
              ...
              >
                ...
                <p className="font-accent text-base text-muted-foreground leading-snug">
                  {p.personality}
                </p>
                {pet === p.id && (
                  <div className="chrome-badge px-2 py-0.5 text-[10px] inline-block">
                    chosen ✓
                  </div>
                )}
              </button>
